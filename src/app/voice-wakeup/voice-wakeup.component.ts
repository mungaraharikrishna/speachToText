...
@Component({
  selector: 'app-voice-wakeup',
  templateUrl: './voice-wakeup.component.html',
  styleUrls: ['./voice-wakeup.component.scss']
})
export class VoiceWakeupComponent {
  ...
  constructor(private porcupineService: PorcupineService) {
    ...
    this.keywordSubscription = porcupineService.keywordDetection$.subscribe(
      porcupineSubscription => {
        console.log(porcupineSubscription)
  ...
  async ngOnInit() {
    await this.porcupineService.init(
      'UZPLfO6JhyKJZMuG/yOoCKOJp9QLQH7pEj4LPiYtw5WGsTkof+feTA==',
